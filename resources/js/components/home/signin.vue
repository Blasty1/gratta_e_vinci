<template>
  ...
  <div class="form-row">
    ...
    <div class="col-md-6 mb-3">
      <input type="password" :class="{'form-control mr-0' : true, 'is-invalid' : password.error}" id="validationServer04" v-model="password.value" placeholder="Password" required>
   ...
   <div class="col-12 p-0" id="buttonGoogleDiv">
        ...
        <button class="btn btn-primary buttonSubmit" type="submit" @click.prevent="submitData()">Registrati</button>
    </div>
  </div>
</form>
    </div>
...
export default {
    ...
    data(){
        return {
            ...
            dataToSubmit : ['email','name','surname','password','street_address']

...
export default {
    data(){
        return{
          optionsToSelect : ['contabilita','contabilita_oggi','contabilita_quotidiana','seleziona_date','contabilita_mensile','magazzino','inserisci_nuovi_pacchi','pacchi_acquistati','aggiungi_dipendenti']
        }
    },
    methods : {
